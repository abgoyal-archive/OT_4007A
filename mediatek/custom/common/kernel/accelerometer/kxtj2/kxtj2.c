...
//static struct i2c_board_info __initdata kxtj2_i2c_board_info  = {	 
//			I2C_BOARD_INFO("kxtj2", KXTJ2_I2C_SLAVE_ADDR>>1)
//		};
...
/*----------------------------------------------------------------------------*/
static long kxtj2_ioctl(struct inode *inode,struct file *file, unsigned int cmd,
       unsigned long arg)
{
...
//	.unlock_ioctl = kxtj2_unlock_ioctl,
	.ioctl = kxtj2_ioctl,
};
/*----------------------------------------------------------------------------*/
...
//	i2c_register_board_info(0,&kxtj2_i2c_board_info ,1);  //register i2c device
