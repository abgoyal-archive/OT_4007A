...
HI253WriteCmosSensor(0x20, 0x80); //X 60 
HI253WriteCmosSensor(0x21, 0x80); //Y 70
...
HI253WriteCmosSensor(0x40, 0x5e); //5c
...
HI253WriteCmosSensor(0x33, 0x28);//29
HI253WriteCmosSensor(0x34, 0x53);//4d
HI253WriteCmosSensor(0x35, 0x76);//6c
HI253WriteCmosSensor(0x36, 0x91);//81
HI253WriteCmosSensor(0x37, 0xa3);//94
HI253WriteCmosSensor(0x38, 0xb4);//a4
HI253WriteCmosSensor(0x39, 0xc0);//b3
HI253WriteCmosSensor(0x3a, 0xc9);//c0
HI253WriteCmosSensor(0x3b, 0xd2);//cb
HI253WriteCmosSensor(0x3c, 0xd9);//d5
HI253WriteCmosSensor(0x3d, 0xdf);//de
HI253WriteCmosSensor(0x3e, 0xe6);
HI253WriteCmosSensor(0x3f, 0xea);//ee
HI253WriteCmosSensor(0x40, 0xef);//f5
HI253WriteCmosSensor(0x41, 0xf5);//fc
...
HI253WriteCmosSensor(0x72, 0x16);//12
HI253WriteCmosSensor(0x73, 0x2e);//2a
HI253WriteCmosSensor(0x74, 0x54);//54
HI253WriteCmosSensor(0x75, 0x75);//6c
HI253WriteCmosSensor(0x76, 0x90);//81
HI253WriteCmosSensor(0x77, 0xa7);//94
HI253WriteCmosSensor(0x78, 0xb6);//a4
HI253WriteCmosSensor(0x79, 0xc2);//b3
HI253WriteCmosSensor(0x7a, 0xca);//c0
HI253WriteCmosSensor(0x7b, 0xd2);//cb
HI253WriteCmosSensor(0x7c, 0xd9);//d5
HI253WriteCmosSensor(0x7d, 0xdf);//de
HI253WriteCmosSensor(0x7e, 0xe6);
HI253WriteCmosSensor(0x7f, 0xea);//ee
HI253WriteCmosSensor(0x80, 0xef);//f4
HI253WriteCmosSensor(0x81, 0xf5);//fa
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
  ...
  pSensorInfo->SensorVideoFrameRate=12;   //30
...
BOOL HI253SetWb(UINT16 Para)
{
  ...
  switch (Para)
  {
    ...
    case AWB_MODE_AUTO:
      ...
      HI253WriteCmosSensor(0x84, 0x14); //18
      HI253WriteCmosSensor(0x85, 0x5b);  //59
...
static void HI253GetEvAwbRef(UINT32 pSensorAEAWBRefStruct/*PSENSOR_AE_AWB_REF_STRUCT Ref*/)
{
	...
	/*
	Ref->SensorAERef.AeRefLV05Shutter = 0x49200;
    Ref->SensorAERef.AeRefLV05Gain = 0xe0; // 7.75x, 128 base 
    Ref->SensorAERef.AeRefLV13Shutter = 0x14;
    Ref->SensorAERef.AeRefLV13Gain =0x1800; // 1x, 128 base 
    Ref->SensorAwbGainRef.AwbRefD65Rgain =  0x4f; // 1.46875x, 128 base 
    Ref->SensorAwbGainRef.AwbRefD65Bgain = 25; // 1x, 128 base 
    Ref->SensorAwbGainRef.AwbRefCWFRgain = 0x3b; // 1.25x, 128 base 
    Ref->SensorAwbGainRef.AwbRefCWFBgain = 47; // 1.28125x, 128 base 
    */
	#endif
}
/*************************************************************************
...
static void HI253GetCurAeAwbInfo(UINT32 pSensorAEAWBCurStruct/*PSENSOR_AE_AWB_CUR_STRUCT Info*/)
{
    ...
    Info->SensorAECur.AeCurGain = HI253ReadGain() ; // 128 base     
    Info->SensorAwbGainCur.AwbCurRgain = HI253ReadAwbRGain();// 128 base     
    Info->SensorAwbGainCur.AwbCurBgain = HI253ReadAwbBGain(); // 128 base 
	 */
