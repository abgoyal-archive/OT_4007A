...
extern void mt6575_irq_mask(unsigned int irq);
extern void mt6575_irq_unmask(unsigned int irq);
extern void mt6575_irq_ack(unsigned int irq);
...
extern int mt6575_irq_set_type(unsigned int irq, unsigned int flow_type);
