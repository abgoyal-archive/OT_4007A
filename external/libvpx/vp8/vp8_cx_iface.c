...
static vpx_codec_err_t vp8e_init(vpx_codec_ctx_t *ctx)
{
    ...
    if (!ctx->priv)
    {
        ...
        if (priv)
        {
             ...
             */
            for (i = 0;
                 extracfg_map[i].usage && extracfg_map[i].usage != (int) cfg->g_usage;
                 i++);
...
static vpx_codec_enc_cfg_map_t vp8e_usage_cfg_map[] =
{
    ...
    { -1,
     {
        NOT_IMPLEMENTED,                    /* g_usage */
        NOT_IMPLEMENTED,                    /* g_threads */
        NOT_IMPLEMENTED,                    /* g_profile */

        NOT_IMPLEMENTED,                    /* g_width */
        NOT_IMPLEMENTED,                    /* g_height */
        {NOT_IMPLEMENTED, NOT_IMPLEMENTED}, /* g_timebase */

        NOT_IMPLEMENTED,                    /* g_error_resilient */

        NOT_IMPLEMENTED,                    /* g_pass */

        NOT_IMPLEMENTED,                    /* g_lag_in_frames */

        NOT_IMPLEMENTED,                    /* rc_dropframe_thresh */
        NOT_IMPLEMENTED,                    /* rc_resize_allowed */
        NOT_IMPLEMENTED,                    /* rc_resize_down_thresold */
        NOT_IMPLEMENTED,                    /* rc_resize_up_thresold */

        NOT_IMPLEMENTED,                    /* rc_end_usage */
#if VPX_ENCODER_ABI_VERSION > (1 + VPX_CODEC_ABI_VERSION)
        {NOT_IMPLEMENTED,NOT_IMPLEMENTED},  /* rc_twopass_stats_in */
#endif
        NOT_IMPLEMENTED,                    /* rc_target_bandwidth */

        NOT_IMPLEMENTED,                    /* rc_min_quantizer */
        NOT_IMPLEMENTED,                    /* rc_max_quantizer */

        NOT_IMPLEMENTED,                    /* rc_undershoot_pct */
        NOT_IMPLEMENTED,                    /* rc_overshoot_pct */

        NOT_IMPLEMENTED,                    /* rc_max_buffer_size */
        NOT_IMPLEMENTED,                    /* rc_buffer_initial_size; */
        NOT_IMPLEMENTED,                    /* rc_buffer_optimal_size; */

        NOT_IMPLEMENTED,                    /* rc_two_pass_vbrbias  */
        NOT_IMPLEMENTED,                    /* rc_two_pass_vbrmin_section */
        NOT_IMPLEMENTED,                    /* rc_two_pass_vbrmax_section */

        /* keyframing settings (kf) */
        NOT_IMPLEMENTED,                    /* g_kfmode*/
        NOT_IMPLEMENTED,                    /* kf_min_dist */
        NOT_IMPLEMENTED,                    /* kf_max_dist */
        
#if VPX_ENCODER_ABI_VERSION == (1 + VPX_CODEC_ABI_VERSION)
        NOT_IMPLEMENTED,                    /* g_delete_first_pass_file */
        NOT_IMPLEMENTED                     /* first pass filename */
#endif
    }}
...
vpx_codec_iface_t vpx_enc_vp8_algo =
{
    ...
    NOT_IMPLEMENTED,    /* vpx_codec_get_mmap_fn_t   get_mmap; */
    NOT_IMPLEMENTED,    /* vpx_codec_set_mmap_fn_t   set_mmap; */
    {NOT_IMPLEMENTED,NOT_IMPLEMENTED,NOT_IMPLEMENTED,NOT_IMPLEMENTED},  /* decoder functions */
    {
        vp8e_usage_cfg_map, /* vpx_codec_enc_cfg_map_t    peek_si; */
