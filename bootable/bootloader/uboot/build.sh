...
#porting from sherry
JRD_UBOOT_LOGO_PATH="../../../beetlelite_wimdata_ng/wcustores/logo"
...
# add for logo.bin customization######
if [ -d ${JRD_UBOOT_LOGO_PATH} ];then
 echo "===JRD logo.bin customization ===" 
   cd ${JRD_UBOOT_LOGO_PATH}; ./update ${BOOT_LOGO}; cd - > /dev/null
    ${MKIMG} ${JRD_UBOOT_LOGO_PATH}/${BOOT_LOGO}.raw LOGO > ${CUR_DIR}/logo.bin
else
